...
""
    }, 
    {
        ...
        offer_desc: 
        "Enjoy in 3 Nights 4 days Offer in GFC",
        offer_image: 
        ...
        offer_inclusion1: 
        "Outdoor, indoor and lawn games.",
        offer_inclusion2: 
        "Access to the swimming pool.",
        offer_name: 
        "3 Nights 4 Days Offer",
        offer_price_for_adult: 
        ...
        offer_uuid: 
        "337fcaeb-2915-4e63-a353-92cbd82e9b53",
        terms_and_condition1: 
...
if(!home_details) {
    ...
    localStorage.setItem("home_details", JSON.stringify([{
        product_desc: 
        ...
        "$33.00",
        product_uuid: 
        "66fb067d-092c-4688-8efc-9e5eb88479e2",
        selecting: 
        "home"
    }]))
}
...
if(!event_details) {
    ...
    localStorage.setItem("event_details", JSON.stringify([{
eventName: 
"Waterfall",
eventPhoto: 
...
events_uuid: 
"d26a2477-ace4-4dff-945f-1bcda83f07e3"
    }, 
    {
eventName: 
"Horror House",
...
events_uuid: 
"33de6bf3-cfd2-49ec-b406-8f896ce6d4a0"
    }, 
    {
        eventName: 
        "3D Cinema",
        ...
        events_uuid: 
        "c00fa2cd-e2b0-4e32-aa4b-47ce154ca89c"
    }]))
}
...
"2024-02-06T09:00",
upcoming_event_uuid: 
"ea55f110-73f7-4d6c-a1fe-f37fd53604b7",
upcoming_event_video: 
"https://youtu.be/PpC8ytyDm60"
    }]))
}